    ...
    const vm = new Vue({
      ...
      methods: {
        ...
        deleteFn: function (viewData) {
          var _this = this;
          this.$confirm('确定要删除【' + viewData.userId + '】吗?', '提示', {
            ...
            yufp.service.request({
              method: 'POST',
              name: backend.appOcaService + '/adminSmUser/delete/' + userId,
        ...
        addData: function () {
          ...
          yufp.service.request({
            method: 'POST',
            data: model,
            name: backend.appOcaService + '/adminSmUser/create',
            callback: function (code, message, response) {
              if (code === 0) {
        ...
        editData: function () {
          ...
          yufp.service.request({
            method: 'POST',
            data: model,
            name: backend.appOcaService + '/adminSmUser/update',
            callback: function (code, message, response) {
              if (code === 0) {
                vm.$message({
                  message: '数据更新成功！'
