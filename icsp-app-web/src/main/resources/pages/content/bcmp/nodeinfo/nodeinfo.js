      ...
      methods: {
        ...
        deleteFn: function (viewData) {
          ...
          this.$confirm('确定要删除【' + viewData.nodeId + '】吗?', '提示', {
            ...
            yufp.service.request({
              method: 'POST',
              data: delData,
              name: backend.bcmpService + '/bcmpSmNodeinfo/delete',
        ...
        addData: function () {
          ...
          yufp.service.request({
            method: 'POST',
            data: model,
            name: backend.bcmpService + '/bcmpSmNodeinfo/create',
            callback: function (code, message, response) {
              if (code === 0) {
        ...
        editData: function () {
          ...
          yufp.service.request({
            method: 'POST',
            data: model,
            name: backend.bcmpService + '/bcmpSmNodeinfo/update',
            callback: function (code, message, response) {
              if (code === 0) {
                vm.$message({
                  message: '数据更新成功！'
        ...
        getHostList: function () {
          ...
          yufp.service.request({
            method: 'GET',
            data: querModel,
            name: backend.bcmpService + '/bcmpSmHostinfo/index',
            callback: function (code, message, response) {
              if (code === 0) {
                var list = [];
