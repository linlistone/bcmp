...
window.demoMenus = [
  ...
  { menuId: 'gm-22012', menuName: '拖拽', upMenuId: 'gm-22000', menuIcon: '', funcId: 'exampleDraggable', funcUrl: 'pages/example/template/exampleDraggable/exampleDraggable' },
  ...
  { menuId: 'gm-22014', menuName: '异步树', upMenuId: 'gm-22000', menuIcon: '', funcId: 'asynctree', funcUrl: 'pages/example/template/exampleTree/exampleTree' },
  ...
  // 四级菜单
  { menuId: 'gm-23101', menuName: '普通查询', upMenuId: 'gm-23100', menuIcon: '', funcId: 'exampleQuery', funcUrl: 'pages/example/template/exampleQuery/exampleQuery'},
  { menuId: 'gm-23102', menuName: '树+查询', upMenuId: 'gm-23100', menuIcon: '', funcId: 'exampleTree', funcUrl: 'pages/example/template/exampleTree/exampleTree'},
  { menuId: 'gm-23103', menuName: '查询+表单（编辑）', upMenuId: 'gm-23100', menuIcon: '', funcId: 'exampleEdit', funcUrl: 'pages/example/template/exampleEdit/exampleEdit'},
  { menuId: 'gm-23104', menuName: '查询+表格（主从表）', upMenuId: 'gm-23100', menuIcon: '', funcId: 'searchTable', funcUrl: 'pages/example/template/searchTable/searchTable'},
  { menuId: 'gm-23105', menuName: 'Tab页签+查询', upMenuId: 'gm-23100', menuIcon: '', funcId: 'tabsearch', funcUrl: 'pages/example/template/tabSearch/tabSearch'},
  { menuId: 'gm-23106', menuName: '查询嵌套表格', upMenuId: 'gm-23100', menuIcon: '', funcId: 'queryNestedTable', funcUrl: 'pages/example/template/queryNestedTable/queryNestedTable'},
  { menuId: 'gm-23107', menuName: '查询嵌套表单', upMenuId: 'gm-23100', menuIcon: '', funcId: 'queryNestedForm', funcUrl: 'pages/example/template/queryNestedForm/queryNestedForm'},
  { menuId: 'gm-23108', menuName: '高级查询', upMenuId: 'gm-23100', menuIcon: '', funcId: 'exampleMoreQuery', funcUrl: 'pages/example/template/exampleMoreQuery/exampleMoreQuery'},

  // 四级菜单
  { menuId: 'gm-23201', menuName: '普通表单（编辑）', upMenuId: 'gm-23200', menuIcon: '', funcId: 'exampleForm', funcUrl: 'pages/example/template/exampleForm/exampleForm'},
  { menuId: 'gm-23202', menuName: '普通表单（详情）', upMenuId: 'gm-23200', menuIcon: '', funcId: 'exampleFormInfo', funcUrl: 'pages/example/template/exampleFormInfo/exampleFormInfo'},
  { menuId: 'gm-23203', menuName: '分组表单', upMenuId: 'gm-23200', menuIcon: '', funcId: 'exampleGroup', funcUrl: 'pages/example/template/exampleGroup/exampleGroup'},
  { menuId: 'gm-23204', menuName: '表单+列表', upMenuId: 'gm-23200', menuIcon: '', funcId: 'tableList', funcUrl: 'pages/example/template/tableList/tableList'},
  { menuId: 'gm-23205', menuName: 'Tab页签表单', upMenuId: 'gm-23200', menuIcon: '', funcId: 'tabform', funcUrl: 'pages/example/template/tabForm/tabForm'},
  { menuId: 'gm-23206', menuName: '表单内嵌套Tabs', upMenuId: 'gm-23200', menuIcon: '', funcId: 'formNestTabs', funcUrl: 'pages/example/template/formNestTab/formNestTab'},
  { menuId: 'gm-23207', menuName: 'Steps步骤表单', upMenuId: 'gm-23200', menuIcon: '', funcId: 'exampleSteps1', funcUrl: 'pages/example/template/exampleSteps1/exampleSteps1'},
