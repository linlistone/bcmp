...
function (require, exports) {
  ...
  var registerService = [
    // 连接后台服务时，请注释下述几行
    { url: msbackend.uaaService + '/oauth/token', method: 'POST', fn: system.loginFn },
    { url: msbackend.uaaService + '/api/logout', method: 'POST', fn: system.logoutFn },
    { url: msbackend.appOcaService + '/api/session/info', method: 'GET', fn: system.sessionInfoFn }
