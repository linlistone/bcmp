	...
	*/
      Handler.gen = function (template, name, context) {
	    ...
	    context = {
	        ...
	        // yufp.logger.debug('path:', context.path.join('.'), templates)
      ...
      Handler.extend({
	    ...
	    placeholder: function (placeholder, obj, templateContext, options) {
	        // yufp.logger.debug(options.context.path)
	        // 1 key, 2 params
	    ...
	    */
	    ...
	    /*
	        ...
	        $('h2').each(function(index, item){
	            item = $(item)
	           yufp.logger.debug('\'' + item.text() + '\'', ':', '\'' + item.next().text() + '\'', ',')
	        })
	    */
	    _brandColors: {
	        '4ormat': '#fb0a2a',
	...
	*/
      ...
      function valid (template, data) {
	    ...
	    for (var i = 0; i < result.length; i++) {
	        // yufp.logger.debug(templates, data)
      ...
      function find (options) {
	    for (var sUrlType in MockXMLHttpRequest.Mock._mocked) {
	        ...
	        if (
	            ...
	            // yufp.logger.debug('[mock]', options.url, '>', item.rurl)
	            return item;
	        }
	    }
