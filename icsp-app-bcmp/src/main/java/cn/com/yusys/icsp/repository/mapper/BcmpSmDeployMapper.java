 ...
 */
//@Mapper
public interface BcmpSmDeployMapper {
	/**
	 * @方法名称: insert
	 * @方法描述: 插入 - 只插入非空字段
	 * @参数与返回说明:
	 * @算法描述: 无
	 */
	int insert(BcmpSmDeploy record);
	 ...
	 * @算法描述:
	 */
	List<BcmpSmDeploy> selectByModel(QueryModel model);
	 ...
	 * @算法描述: 无
	 */
	int deleteByPrimaryKey(@Param("deployId") String deployId);
