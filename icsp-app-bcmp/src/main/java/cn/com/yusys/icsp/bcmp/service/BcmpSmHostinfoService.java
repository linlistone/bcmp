package cn.com.yusys.icsp.bcmp.service;

import cn.com.yusys.icsp.base.base.BaseService;
import cn.com.yusys.icsp.common.mapper.QueryModel;
import cn.com.yusys.icsp.bcmp.domain.BcmpSmHostinfo;
import cn.com.yusys.icsp.bcmp.repository.mapper.BcmpSmHostinfoMapper;
...
public class BcmpSmHostinfoService extends BaseService {
	...
	public BcmpSmHostinfo show(String hostId) throws Exception {
		...
		List<BcmpSmHostinfo> list = index(model);
		if (list == null || list.isEmpty()) {
			throw new ICSPException("数据不存在" + hostId);
		}
		BcmpSmHostinfo bcmpSmHostinfo = list.get(0);
	 ...
	 * @算法描述: 无
	 */
	public List<BcmpSmHostinfo> index(QueryModel model)
			throws Exception {
