...
public class BcmpSmServerClusterResource {
    ...
    public ResultDto<Map<String, Integer>> startAppBatch(@RequestBody JSONObject request) throws Exception {
        Map<String, Integer> response = bcmpSmServerClusterService.startAppBatch(request);
    ...
    public ResultDto<Map<String,Integer>> shutdownAppBatch(@RequestBody JSONObject request) throws Exception {
        Map<String, Integer> response = bcmpSmServerClusterService.shutdownAppBatch(request);
        return ResultDto.success(response);
    }
    /*
