 ...
 */
//@Mapper
public interface BcmpCmNodeinfoMapper {
	/**
	 * @方法名称: insert
	 * @方法描述: 插入 - 只插入非空字段
	 * @参数与返回说明:
	 * @算法描述: 无
	 */
	int insert(BcmpCmNodeinfo record);
	 ...
	 * @算法描述:
	 */
	List<BcmpCmNodeinfo> selectByModel(QueryModel model);
	 ...
	 * @算法描述: 无
	 */
	int updateByPrimaryKey(BcmpCmNodeinfo record);
