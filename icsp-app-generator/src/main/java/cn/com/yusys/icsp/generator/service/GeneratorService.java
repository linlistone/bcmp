package cn.com.yusys.icsp.generator.service;

import cn.com.yusys.icsp.common.mapper.QueryModel;
import cn.com.yusys.icsp.generator.repository.mapper.GeneratorMapper;
import cn.com.yusys.icsp.generator.util.GenUtils;
...
public class GeneratorService {
	...
	public  List<Map<String, Object>> queryColumnList(QueryModel model) {
		PageHelper.startPage(model.getPage(), model.getSize());
		PageHelper.startPage(model.getPage(), model.getSize());
